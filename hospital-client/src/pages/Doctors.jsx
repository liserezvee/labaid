  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 m-5">
        <button className={`py-1 px-2 border rounded text-sm transition-all sm:hidden ${showFilter ? 'bg-primary text-white': ''}`} onClick={()=>setShowFilter(prev=>!prev)}>Filters</button>
        <div className={` flex-col gap-4 text-sm text-gray-600 ${showFilter ? 'flex': 'hidden sm:flex'}`}>
          <p
            ...
            className={`w-2xs sm:w-auto pl-3 pr-16 py-1.5 border border-gray-300 rounded-lg transition-all cursor-pointer ${
              speciality === "General physician"
